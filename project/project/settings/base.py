...
# Generate a new fresh SECRET_KEY to every new project
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'grappelli',
    'django.contrib.admin',  # Have to be loaded after Grappelli
...
# No default provided. Defined in the specific environment
...
STATIC_ROOT = '/wrkdir/static'
STATIC_URL = '/static/'

MEDIA_ROOT = '/wrkdir/media'
MEDIA_URL = '/media/'
